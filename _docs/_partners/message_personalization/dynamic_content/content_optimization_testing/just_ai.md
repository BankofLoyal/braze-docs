...
3. In the message composer, paste in the Connected Content snippet from JustAI Console, such as the following snippet.
...
![Braze message preview for a JustAI email.]({% image_buster /assets/img/just_words/just_words_preview.png %}){: style="max-width:80%;"}
