---
nav_title: Localization settings
article_title: Localization settings
...
For steps to use these locales in your messages, see [Multi-language messages]({{site.baseurl}}/user_guide/engagement_tools/messaging_fundamentals/localization/locales/).
