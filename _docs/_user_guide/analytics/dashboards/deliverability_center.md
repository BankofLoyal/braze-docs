...
6. After the TXT record is added to the DNS, return to the Google Postmaster Tools dashboard and select **Verify**. This step confirms you own the domain, so you can access Gmail deliverability metrics in your Postmaster account. 
8. After verifying the root (parent) domain, add your sending subdomains to Google Postmaster.
