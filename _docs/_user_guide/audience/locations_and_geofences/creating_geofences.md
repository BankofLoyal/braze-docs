...
3. (Optional) Select **Show Advanced Settings**. Within this section, you can configure options for geofence analytics, which allow you to measure location-based engagement, build audiences from store visits, and trigger follow-up messaging after consumers enter or exit key locations.
