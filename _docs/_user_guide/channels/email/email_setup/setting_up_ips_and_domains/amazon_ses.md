---
nav_title: Amazon SES setup
article_title: Amazon SES setup
page_order: 1
page_type: reference
...
- If Amazon SES is your email service provider, Microsoft Smart Network Data Services (SNDS) isn't supported.
