...
#### Foreground push enabled versus background push enabled
...
To do this, create a [sunset policy]({{site.baseurl}}/user_guide/channels/email/best_practices/sunset_policies) that eventually stops sending push notifications to users who haven't had a direct or influenced open for a long time.
