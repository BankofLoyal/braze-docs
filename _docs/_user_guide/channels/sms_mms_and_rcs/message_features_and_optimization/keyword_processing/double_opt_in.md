...
[Preference Center]({{site.baseurl}}/user_guide/channels/email/preference_center) | Users will automatically enter into the double opt-in workflow when subscribed through a preference center.
